...
![Amazon S3](https://img.shields.io/badge/Amazon_S3-FF9900?style=flat-square&logo=amazons3&logoColor=white)
...
### 🗣️ [talkertive-chat-app](https://github.com/Poeta0923/talkertive-chat-app)
관심사 기반 모임 + 실시간 채팅 풀스택 플랫폼

- **Stack:** Next.js 15 · NestJS 11 · PostgreSQL · Redis · Socket.io · AWS S3
- **AI:** Claude API를 활용한 자연어 기반 일정 생성·수정·삭제
- **Auth:** NextAuth v5 + Passport JWT (NestJS와 토큰 공유)
